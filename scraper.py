...
# -------------------------------------------------
BUSINESS_QUERIES = [
    "Automated Barrier Installation Service in",
    "Vehicle Access Control Service in",
    "Security Gate System Installer in",
    "Entry Control System Installer in",
    "Intercom System Installer in",
]
